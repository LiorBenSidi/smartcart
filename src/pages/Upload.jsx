      ...
      <div className="text-center space-y-2 relative">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              size="icon"
              variant="ghost" className="bg-[#ffff80] text-[#000000] text-sm font-medium opacity-100 rounded-full inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:text-accent-foreground absolute top-0 right-0 h-8 w-8 hover:bg-gray-100 dark:hover:bg-gray-800">


              <HelpCircle className="h-20 w-20 text-gray-400 hover:text-indigo-600" />
            </Button>
          </DialogTrigger>
