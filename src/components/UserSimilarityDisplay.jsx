...
export default function UserSimilarityDisplay({ currentUser, insight }) {
    ...
    return (
        <Card className="border-indigo-100 dark:border-indigo-900 bg-gradient-to-br from-white to-indigo-50/30 dark:from-gray-800 dark:to-indigo-950/20">
            ...
            <CardContent>
                {insight && (
                    <div className="mb-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-900/50 rounded-lg p-3 flex gap-3 animate-in fade-in slide-in-from-top-2">
